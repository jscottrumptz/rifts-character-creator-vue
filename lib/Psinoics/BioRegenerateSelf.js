...
class BioRegenerateSelf extends Psionic {
    constructor() {
        ...
        this.note = `Recovering more than half of one's Hit Points or S.D.C. this way in less than an hour takes a toll on the character, causing some weakness for 1D4+2 hours: reduce the P.S., P.E. and Spd attributes by 30%. Adjust attribute bonuses accordingly.`
        this.range = 'Self.';
