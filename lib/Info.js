const { Random, die } = require('random-js');
...
class Info {
    ...
    randomDisposition() {   
        ...
        if (chance <= 10 && chance > 0) {
            ...
            this.birthOrder = 'Schemer/Dreamer - Always looking ahead, never in the present, and dislikes the past. Thinking ahead and plotting for the future is a good trait sometimes. but a bad one other times, because it tends to miss the obvious ("what if ... ") and forgets the reality of the here and now.'
        } 
    }
