        ...
        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tr v-for="(bonuses,index) in bonuses" v-bind:key="index" class="bg-white border-t border-gray-200" >
              <td v-if="bonuses.initialValue + bonuses.attributeBonus + bonuses.occBonus + bonuses.raceBonus + bonuses.skillsBonus + bonuses.cyberneticBonus  + bonuses.otherBonus !== 0" colspan="2" class="px-6 py-2 whitespace-nowrap text-sm font-medium text-gray-900">
                {{bonuses.name}}
              </td>
