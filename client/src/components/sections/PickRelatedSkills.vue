...
export default {
  ...
  methods: {
        ...
        if(skill.name.includes('Hand to Hand')) {
          ...
          for (const [key] of Object.entries(this.selectedSkills)) {
            if (key.includes('andToHand')) {
              ...
              this.physicalCount = this.physicalCount - this.selectedSkills[key].skillCost;
    ...
    init: function() {
      ...
      // give character the base hand to hand skill if they haven't selected one
      if (!handToHand) {
        this.selectedSkills[this.newCharacter.occ.startingHandToHand] = this.physical[this.newCharacter.occ.startingHandToHand]
        this.newCharacter.skills.known[this.newCharacter.occ.startingHandToHand] = this.physical[this.newCharacter.occ.startingHandToHand]
        this.selectedSkills[this.newCharacter.occ.startingHandToHand].canRemove = false
        // remove it from physical group list
        delete this.physical[this.newCharacter.occ.startingHandToHand]
      }
