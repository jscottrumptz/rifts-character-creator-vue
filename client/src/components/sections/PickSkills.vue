<template>
  <div class="px-5 pb-5">
    <p v-if="!newCharacter.race.rcc" class="text-white text-xl font-medium p-5" >Pick O.C.C skills</p>
    <p v-if="newCharacter.race.rcc" class="text-white text-xl font-medium p-5" >Pick R.C.C skills</p>
