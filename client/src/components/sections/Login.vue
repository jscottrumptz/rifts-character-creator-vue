<template>
  <div class="min-h-screen bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <h2 v-if="!newAccount" class="mt-6 text-center text-3xl font-extrabold text-gray-50">
      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        ...
        <form v-if="newAccount" @submit="handleSignUpFormSubmit" class="space-y-6" action="#" method="POST">
          <div>
            ...
            <div class="mt-1">
              <input id="signUpUsername" v-model="username" name="username" type="username" autocomplete="username" required="" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
            </div>
          </div>
