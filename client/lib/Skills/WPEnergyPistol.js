...
class WPEnergyPistol extends Skill {
    constructor() {
        super();
        this.name = `W.P. Energy Pistol`;
        this.group = `Weapon Proficiencies Modern`;
        this.isSecondary = true;
        this.note = `Training: Enables the character to easily reload, disassemble, unjam, clean, or otherwise maintain the weapon.

Recognise Weapon Quality: -30% at level 1, +6% per level of experience.`;
        this.description = `This modern weapon proficiency includes lasers and all types of energy firing small arms.`;
